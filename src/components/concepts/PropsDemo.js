    ...
    return (
        <div className="main">
            <div className="mainDiv">
                <div style={styles}>
                    <FunctionalComponent string="Toggle Text Color" function={toggleColor} selectedStyle={ color } />
                    ...
                    <FunctionalComponent string="I want some thai food" function={toggleBorderStyle} selectedStyle={ borderStyle } />
                </div>
            </div>
        </div>
    )
...
const FunctionalComponent = (props) => {
    return(
        <div>
            <p>{props.string}</p>
            <button onClick={props.function}>Toggle Me Bro</button>
